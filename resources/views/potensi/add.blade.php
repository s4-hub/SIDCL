            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{url('/potensi/create')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label for="exampleInputText1">Nama Potensi</label>
                                <input name="nama" type="text" class="form-control {{$errors->has('nama') ? 'is-invalid' : ''}}" id="exampleInputText1" placeholder="Input Nama Potensi" value="{{old('nama')}}" required>
                                @if($errors->has('nama'))
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat" id="textarea-input" rows="3" placeholder="Input Alamat Potensi" class="form-control">{{old('alamat')}}</textarea>
                                @if($errors->has('alamat'))
                                <div class="invalid-feedback">{{$errors->first('alamat')}}</div>
                                @endif
                            </div>
                            <div class="form-group">
                                <label for="exampleInputText1">Jumlah TK Potensi</label>
                                <input name="jum_tk_potensi" type="text" class="form-control {{$errors->has('jum_tk_potensi') ? 'is-invalid' : ''}}" id="exampleInputText1" placeholder="Input Jumlah TK Potensi" value="{{old('jum_tk_potensi')}}" required>
                                @if($errors->has('jum_tk_potensi'))
                                    <div class="invalid-feedback">{{$errors->first('jum_tk_potensi')}}</div>
                                @endif
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row form-group">
                                    <div class="col col-lg-6">
                                        <label for="file-input" class=" form-control-label">Tentukan Koordinat Potensi</label>
                                    </div>
                                    <div class="col col-lg-6">
